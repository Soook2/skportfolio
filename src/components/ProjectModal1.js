        ...
        <div className={styles.middle}>
            ...
            <div className={styles.subcontent}>
                <div className={styles.gifdiv}>
                    <img  src={`${process.env.PUBLIC_URL}/project/main2.gif`} alt="" className={styles.gifimage}/>
                </div>
            </div>
            ...
            <div className={styles.subcontent}>
                 <Row >
                    <Col lg = {9} md= {24} className={styles.col1}>
                        ...
                        { 
                            isHover1 ?
                            <img  src={`${process.env.PUBLIC_URL}/project/regi_db.png`} alt="" className={styles.dbimage} data-aos="fade-left"/>
                            :
                            <div></div>                        
                        }
                    </Col>
                    ...
                    <div className={styles.gifdiv}>
                        <img  src={`${process.env.PUBLIC_URL}/project/register.gif`} alt="" className={styles.gifimage}/>
                        <img  src={`${process.env.PUBLIC_URL}/project/login.gif`} alt="" className={styles.gifimage}/>
                    </div>
                    </Col>
                </Row>
            </div>
            ...
            <div className={styles.subcontent}>
                 <Row >
                    <Col lg= {15} md= {24} className={styles.colcontent}>
                    <div className={styles.gifdiv}>
                        <img  src={`${process.env.PUBLIC_URL}/project/upload.gif`} alt="" className={styles.gifimage}/>
                        <img  src={`${process.env.PUBLIC_URL}/project/cart.gif`} alt="" className={styles.gifimage}/>
                    </div>
                    </Col>
                    <Col lg = {9} md= {24} className={styles.col2}>
                        ...
                        { 
                            isHover2 ?
                            <img  src={`${process.env.PUBLIC_URL}/project/upload_db.png`} alt="" className={styles.dbimage} data-aos="fade-right"/>
                            :
                            <div></div>                        
                        }
                    </Col>
                ...
                <div className={styles.respondiv}>
                    <Row>
                        <Col lg= {5} md= {24} className={styles.colcontent}>
                            ...
                            <img  src={`${process.env.PUBLIC_URL}/project/store7.png`} alt="" className={styles.responimage1}/>
                        </Col>
                        <Col lg = {8} md= {24} className={styles.colcontent}>
                            <p className={styles.responcontent}>820 x 1180(테블릿)</p>
                            <img  src={`${process.env.PUBLIC_URL}/project/store8.png`} alt="" className={styles.responimage2}/>
                        </Col>
                        <Col lg = {11} md= {24} className={styles.colcontent}>
                            <p className={styles.responcontent}>1920 x 1080(웹)</p>
                            <img  src={`${process.env.PUBLIC_URL}/project/store9.png`} alt="" className={styles.responimage3}/>
                        </Col>
                    </Row>
                </div>
            </div>
